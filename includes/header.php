    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="animals.php">Animaux</a></li>
                <li class="nav-item"><a class="nav-link" href="visits.php">Visites</a></li>
            </ul>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <?php if (!isset($_SESSION['id'])): ?>
                    ...
                    <li class="nav-item"><a class="nav-link btn btn-maroc ms-lg-2" href="register.php">Inscription</a></li>
